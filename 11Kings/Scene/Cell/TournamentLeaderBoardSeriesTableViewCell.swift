//
//  TournamentLeaderBoardSeriesTableViewCell.swift
//  11Kings
//
...
class TournamentLeaderBoardSeriesTableViewCell: UITableViewCell {
    ...
    func configureCell(seriesResponse:LeaderBoardSeriesDetail) {
