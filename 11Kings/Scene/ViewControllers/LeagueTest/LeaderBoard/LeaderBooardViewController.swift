...
import UIKit
import SwiftyJSON
class LeaderBooardViewController: BaseClass {
...
//        addNavigationBar(navigationTitle: "Contest", titleContentMode: .center, isNavImageShow: false, isBackButtonShow: true, isWalletButtonShow: true, isBinButtonShow: false)
//        setContestData()
//        getLeaderboardData()
//        fetchAccountData()
...
//                    
////                    let responseData = try JSONSerialization.data(withJSONObject: response!, options: [])
////                    let responseModel = try JSONDecoder().decode([GetLEaderBoardResponse].self, from: responseData)
...
//                            
//                        }
//                        //                                      let list =  WinnerbreakUpResponse(json: dataresponse)
//                        //                                      self.winnerBrkupRespnse.append(list)
...
//            Loader.showToast(message: "No Winner Breakup", onView: self.view, bottomMargin: 200, color: .red)
//            return
//        }
...
//                    Loader.showToast(message: "File already exist", onView: self.view, bottomMargin: 200, color: .red)
//                    print("\(writeError)")
//                }
//            } else {
//                Loader.showToast(message: "Unable to find PDF", onView: self.view, bottomMargin: 200, color: .red)
...
//            } else {
//                cell.configureCell(homeType: homeType, entryFee: Double(entreeFee), amount: amount, chalID: challengeId, winning: winning, winners: winners)
//            }
...
//                }
//            } else {
//                Loader.showToast(message: "You can preview team after match start", onView: self.view, bottomMargin: 200, color: .red)
//                
//            }
//        }
//    }
