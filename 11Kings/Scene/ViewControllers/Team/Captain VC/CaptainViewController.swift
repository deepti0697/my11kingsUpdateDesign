...
class CaptainViewController: BaseClass {
    ...
    @IBAction func saveTeamButtonAction(_ sender: UIButton) {
        if v == 0 || c == 0 {
            Loader.showToast(message: "Please choose SuperKing and King  both", onView: self.view, bottomMargin: 200, color: UIColor(red: 240, green: 75, blue: 80))
...
extension CaptainViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.matchTypeC = matchType
         cell.viceCaptainSelectedBy.isHidden = false
